  ...
  methods: {
    ...
    alterarSituacao() {
      ...
      if (novaSituacao && novaSituacao.length > 0) {
        fetch("http://cenufes.kinghost.net/app/alterarSituacao", {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
    ...
    finalizarAtendimento() {
      if (window.confirm('Tem certeza que deseja finalizar o atendimento?')) {
          fetch("http://cenufes.kinghost.net/app/finalizarAtendimento", {
              method: 'POST',
              headers: {
                  'Content-Type': 'application/json'
              },
    ...
    enviarArquivo() {
      ...
      fetch('http://cenufes.kinghost.net/app/salvarArquivo', {
        method: 'POST',
        body: formData
      })
        .then(response => {
    ...
    criarProntuario() {
      ...
      if (prontuario.tipo == "retorno") {
          fetch('http://cenufes.kinghost.net/app/criarProntuarioRetorno', {
              method: 'POST',
              headers: {
                  'Content-Type': 'application/json',
              },
          ...
          fetch('http://cenufes.kinghost.net/app/criarNovoProntuario', {
              method: 'POST',
              headers: {
                  'Content-Type': 'application/json',
              },
    ...
    atualizarProntuariosNoPaciente(prontuario){
      fetch('http://cenufes.kinghost.net/app/atualizarProntuariosNoPaciente', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
